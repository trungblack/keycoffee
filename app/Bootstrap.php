...
class Bootstrap
{
    ...
    public function run()
    {
        ...
        $assetsManager->collection('theme-css')
            ->addCss('http://maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css')
            ...
            ->addCss('http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800&subset=latin,cyrillic-ext')
            ->addCss('http://fonts.googleapis.com/css?family=Merriweather:400,300,300italic,400italic,700,700italic,900,900italic')
        ...
        $assetsManager->collection('theme-js')
            ->addJs('vendor/metronic/js/breakpoints.js')
            ->addJs('vendor/metronic/js/jquery/jquery-1.11.1.min.js')
            ->addJs('vendor/metronic/js/scrollspy.js')
            ->addJs('vendor/metronic/js/bootstrap-progressbar/bootstrap-progressbar.js')
            ->addJs('vendor/metronic/js/bootstrap.min.js')
            ->addJs('vendor/metronic/js/masonry.pkgd.min.js')
            ->addJs('vendor/metronic/js/imagesloaded.pkgd.min.js')
            ->addJs('vendor/metronic/js/bxslider/jquery.bxslider.min.js')
            ->addJs('vendor/metronic/js/flexslider/jquery.flexslider.js')
            ->addJs('vendor/metronic/js/smooth-scroll/SmoothScroll.js')
            ->addJs('vendor/metronic/js/jquery.carouFredSel-6.2.1-packed.js')
            ->addJs('vendor/metronic/js/rs-plugin/js/jquery.themepunch.plugins.min.js')
            ->addJs('vendor/metronic/js/rs-plugin/js/jquery.themepunch.revolution.min.js')
            ->addJs('vendor/metronic/js/rs-plugin/videojs/video.js')
            ->addJs('vendor/metronic/js/jqueryui/jquery-ui.js')
            ->addJs('vendor/metronic/js/modules/sliders.js')
            ->addJs('vendor/metronic/js/modules/ui.js')
            ->addJs('vendor/metronic/js/modules/retina.js')
            ->addJs('vendor/metronic/js/modules/animate-numbers.js')
            ->addJs('vendor/metronic/js/modules/parallax-effect.js')
            ->addJs('vendor/metronic/js/modules/settings.js')
            ->addJs('vendor/metronic/js/modules/maps-google.js')
            ->addJs('vendor/metronic/js/modules/color-themes.js')
            ->addJs('vendor/metronic/js/audioplayer/js/jquery.jplayer.min.js')
            ->addJs('vendor/metronic/js/audioplayer/js/jplayer.playlist.min.js')
            ->addJs('vendor/metronic/js/radial-progress/jquery.easing.1.3.js')
            ->addJs('http://cdnjs.cloudflare.com/ajax/libs/d3/3.4.13/d3.min.js')
            ->addJs('vendor/metronic/js/radial-progress/radialProgress.js')
            ->addJs('vendor/metronic/js/progressbars.js')
            ->addJs('vendor/metronic/js/google-chart.js')
            ->addJs('vendor/metronic/js/j.placeholder.js')
            ->addJs('vendor/metronic/js/fancybox/jquery.fancybox.pack.js')
            ->addJs('vendor/metronic/js/fancybox/jquery.mousewheel.pack.js')
            ->addJs('vendor/metronic/js/fancybox/jquery.fancybox.custom.js')
            ->addJs('vendor/metronic/js/user.js')
            ->addJs('vendor/metronic/js/timeline.js')
            ->addJs('vendor/metronic/js/fontawesome-markers.js')
            ->addJs('vendor/metronic/js/markerwithlabel.js')
            ->addJs('vendor/metronic/js/cookie.js')
            ->addJs('vendor/metronic/js/loader.js')
            ->addJs('vendor/metronic/js/scrollIt/scrollIt.min.js')
            ->addJs('vendor/metronic/js/modules/navigation-slide.js');
