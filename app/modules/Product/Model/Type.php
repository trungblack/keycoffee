...
class Type extends Model
{
    ...
    protected $translateModel = 'Product\Model\Translate\TypeTranslate';
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'Product\Model\Product', 'type_id', array(
            'alias' => 'products'
        ));
    }
    ...
    {
        return HOST_HASH . md5('Product\Model\Type; slug = ' . $slug);
    }

    public static function cacheListKey()
    {
        return HOST_HASH . md5('Product\Model\Type; list');
    }
