...
<form method="post" class="ui form" action="" enctype="multipart/form-data">
    ...
    <div class="ui segment">
        ...
        <a href="/product/type?lang={{  constant('LANG') }}" class="ui button">
        ...
        {% if model.getId() %}
            ...
            <a href="/product/type/add" class="ui button">
                <i class="icon add"></i> Add New
            </a>

            <a href="/product/type/delete/{{  model.getId() }}?lang={{  constant('LANG') }}" class="ui button red">
